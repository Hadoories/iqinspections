          ...
          <div className="mx-auto max-w-6xl space-y-8 px-4 md:px-6">
            <div className="max-w-2xl space-y-6">
              ...
              <p className="max-w-xl text-base leading-relaxed text-white/95 md:text-lg">
                Enjoy your pool with confidence. We check pool structure, equipment, and safety features to ensure everything is in working order and safe for use.
              </p>
            </div>
      ...
      <section className="section-shell bg-white">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl font-bold text-slate-900 md:text-4xl">What We Inspect</h2>
          </div>

          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded border border-slate-200 bg-gradient-to-br from-white to-sky-50 p-6">
              <h3 className="mb-2 text-lg font-semibold text-slate-900">Pool Shell & Structure</h3>
              <p className="text-sm text-slate-600">Check for cracks, leaks, and structural integrity of the pool.</p>
            </div>
            <div className="rounded border border-slate-200 bg-gradient-to-br from-white to-sky-50 p-6">
              <h3 className="mb-2 text-lg font-semibold text-slate-900">Pumps, Filters & Heaters</h3>
              <p className="text-sm text-slate-600">Evaluate all mechanical equipment for proper operation.</p>
            </div>
            <div className="rounded border border-slate-200 bg-gradient-to-br from-white to-sky-50 p-6">
              <h3 className="mb-2 text-lg font-semibold text-slate-900">Safety Barriers</h3>
              <p className="text-sm text-slate-600">Verify fencing, gates, and safety features meet standards.</p>
            </div>
            <div className="rounded border border-slate-200 bg-gradient-to-br from-white to-sky-50 p-6">
              <h3 className="mb-2 text-lg font-semibold text-slate-900">Electrical Systems</h3>
              <p className="text-sm text-slate-600">Inspect bonding, lighting, and electrical safety compliance.</p>
            </div>
            <div className="rounded border border-slate-200 bg-gradient-to-br from-white to-sky-50 p-6">
              <h3 className="mb-2 text-lg font-semibold text-slate-900">Decking & Coping</h3>
              <p className="text-sm text-slate-600">Assess surrounding surfaces for safety and condition.</p>
            </div>
            <div className="rounded border border-slate-200 bg-gradient-to-br from-white to-sky-50 p-6">
              <h3 className="mb-2 text-lg font-semibold text-slate-900">Plumbing & Drains</h3>
              <p className="text-sm text-slate-600">Check all plumbing connections and drainage systems.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="text-center">
              ...
              <p className="text-sm text-slate-600">Book your pool inspection at a time that works for you.</p>
            </div>
            <div className="text-center">
              <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded bg-sky-600 text-2xl font-bold text-white">
                2
              ...
              <p className="text-sm text-slate-600">We thoroughly evaluate structure, equipment, and safety features.</p>
            </div>
            <div className="text-center">
              <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded bg-sky-600 text-2xl font-bold text-white">
                3
              ...
              <p className="text-sm text-slate-600">Receive detailed findings with photos and maintenance recommendations.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            <div className="rounded border border-slate-200 bg-white p-6">
              ...
              <p className="text-sm text-slate-600">
                Most pool inspections take 1-2 hours depending on pool size, features, and equipment complexity.
              </p>
            </div>
            <div className="rounded border border-slate-200 bg-white p-6">
              <h3 className="mb-2 text-lg font-semibold text-slate-900">Can I Request a Re-Evaluation?</h3>
              <p className="text-sm text-slate-600">
                Yes, we offer follow-up inspections after repairs or maintenance to ensure all issues have been properly addressed.
              </p>
            </div>
            <div className="rounded border border-slate-200 bg-white p-6">
              <h3 className="mb-2 text-lg font-semibold text-slate-900">Do You Test Water Chemistry?</h3>
              <p className="text-sm text-slate-600">
                We perform visual and functional inspections but do not provide lab testing. We can coordinate with pool service professionals for chemistry analysis.
              </p>
            </div>
          </div>
        </div>
